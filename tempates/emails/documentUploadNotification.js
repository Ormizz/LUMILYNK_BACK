module.exports = function documentUploadNotification({ studentName, documentType, formattedDate }) {
    return `
                        ...
                        <table cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center" style="border-collapse:collapse;background-color:#FFFFFF;border-top:10px dashed #319bd7;border-bottom:10px dashed #319bd7;width:600px;">
                          ...
                          <tr>
                            <td style="padding:20px;background-image:url('https://fvtnuav.stripocdn.email/content/guids/CABINET_a82aef5be178574d276132abed656b7098f4a6283b7a7945e45077bbe241909e/images/favicon.png');background-repeat:no-repeat;background-position:center; background-size: 45%;">
                              ...
                              <p style="margin:15px 0 0 0;font-family:Arial, Helvetica, sans-serif;line-height:21px;font-size:14px;color:#333;">Nous avons bien reçu votre document : <strong>${documentType}</strong>.</p>
                              <p style="margin:10px 0;font-family:Arial, Helvetica, sans-serif;line-height:21px;font-size:14px;color:#333;">
                                Votre document est en cours de vérification par notre équipe. Vous serez notifié dès que le statut sera mis à jour (Accepté, Refusé, ou En étude).
                                <br><br>
                                Merci de nous avoir fait confiance pour votre dossier d'admission.
                              </p>
