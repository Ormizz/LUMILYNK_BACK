module.exports = function paymentNotification({ studentName, amount, reference, formattedDate, type = "paiement" }) {
  ...
  return `
    ...
    <head>
      <meta charset="UTF-8">
      <title>Confirmation d'envoi de paiement</title>
    </head>
              ...
              <tr>
                <td style="padding:20px;" align="left">
                  ...
                  <p style="margin:20px 0 0 0; font-size:15px; color:#333; line-height:22px;">
                    Nous avons bien reçu le paiement de votre <strong>${type}</strong> d’un montant de
                    <strong>${amount} XOF</strong> avec la référence <strong>${reference}</strong>.
                  </p>

                  <p style="margin:10px 0 0 0; font-size:15px; color:#333; line-height:22px;">
                    Votre paiement est actuellement en cours de <strong>vérification</strong> par notre équipe.
                    Vous recevrez un message de confirmation dès qu’il sera validé.
                  </p>
                  ...
                  <p style="margin:15px 0 0 0; font-size:14px; color:#333; line-height:21px;">
                    Merci pour votre confiance. Vous pouvez suivre l’état de vos paiements et de votre dossier
