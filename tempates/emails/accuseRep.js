module.exports = function accuseRep({ name, formattedDate }) {
    return `
                    ...
                    <tr>
                      <td align="center">
                        <table cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center" style="border-collapse:collapse;background-color:#FFFFFF;border-top:10px dashed #319bd7;border-bottom:10px dashed #319bd7;width:600px;">
                          ...
                          <tr>
                            <td style="padding:20px;background-image:url('https://fvtnuav.stripocdn.email/content/guids/CABINET_a82aef5be178574d276132abed656b7098f4a6283b7a7945e45077bbe241909e/images/favicon.png');background-repeat:no-repeat;background-position:center 80px;">
                              ...
                              <p style="margin:15px 0 0 0;font-family:Arial, Helvetica, sans-serif;line-height:21px;font-size:14px;color:#333;">C'est avec une joie que nous vous remercions de nous avoir contacté.</p>
                              <p style="margin:10px 0;font-family:Arial, Helvetica, sans-serif;line-height:21px;font-size:14px;color:#333;">
                                Nous prenons acte de votre message et nous vous repondrons dans les plus brefs delais.
                                <br><br>
                              </p>
